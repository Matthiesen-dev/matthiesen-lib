...
public class ItemDecoder {
    ...
    public static Item stringToItem(String string, Item fallback) {
        ...
        if (item == Items.AIR) {
            ...
            MatthiesenLibApiConstants.createErrorLog("Failed to decode item from string: " + string + ". Defaulting to fallback item: " + fallbackKey);
            return fallback;
        }
        return item;
    }
    ...
    public static Block stringToBlock(String string, Block fallback) {
        ...
        if (block == Blocks.AIR) {
            ...
            MatthiesenLibApiConstants.createErrorLog("Failed to decode block from string: " + string + ". Defaulting to fallback block: " + fallbackKey);
            return fallback;
        }
        return block;
    }
