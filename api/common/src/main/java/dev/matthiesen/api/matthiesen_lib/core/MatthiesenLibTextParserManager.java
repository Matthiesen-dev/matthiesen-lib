...
import dev.matthiesen.api.matthiesen_lib.core.text_parser.MatthiesenLibVanillaTextParser;
...
public final class MatthiesenLibTextParserManager {
    ...
    public static synchronized void modInitializer() {
        ...
        initialized = true;
        MatthiesenLibConstants.createInfoLog("Initialized text parser manager");
