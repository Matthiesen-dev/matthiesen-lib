package dev.matthiesen.api.matthiesen_lib.config;
...
import dev.matthiesen.api.matthiesen_lib.core.MatthiesenLibConstants;
...
public class ConfigManager<T> {
    ...
    public ConfigManager(Class<T> configClass, String configName) {
        this(configClass, configName, MatthiesenLibConstants.MOD_ID);
    }
