...
public interface ScreenRegistrar {
    /**
     * Registers a menu screen for a given menu type. This should be called during client initialization to ensure that the screen is properly registered and can be opened when needed.
     ...
     * @param screenConstructor A constructor reference for creating instances of the screen. This should be a functional interface that takes in the menu and returns a new instance of the screen, allowing the platform to create the screen when the menu is opened.
     */
