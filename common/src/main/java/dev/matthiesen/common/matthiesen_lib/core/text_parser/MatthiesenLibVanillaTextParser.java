 ...
 */
@Deprecated
public class MatthiesenLibVanillaTextParser extends dev.matthiesen.api.matthiesen_lib.core.text_parser.MatthiesenLibVanillaTextParser implements MatthiesenLibExtendedTextParser {
    /**
