...
/**
 * @deprecated Use {@link dev.matthiesen.api.matthiesen_lib.config.ConfigManager} instead.
 */
@Deprecated
@SuppressWarnings("unused")
public class ConfigManager<T> extends dev.matthiesen.api.matthiesen_lib.config.ConfigManager<T> {
