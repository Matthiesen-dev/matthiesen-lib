...
> Note: For regular users, this library does nothing on it's own. It's a tool for mod developers to write shared code that works on both Fabric and NeoForge without needing separate implementations.
