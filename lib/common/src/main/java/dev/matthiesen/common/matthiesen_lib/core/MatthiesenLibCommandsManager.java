...
public final class MatthiesenLibCommandsManager {
    ...
    public static void modInitializer() {
        dev.matthiesen.common.matthiesen_lib_api.core.MatthiesenLibCommandsManager.modInitializer();
    }

    public static void registerCommand(AbstractCommand command) {
        dev.matthiesen.common.matthiesen_lib_api.core.MatthiesenLibCommandsManager.registerCommand(command);
    }
}
